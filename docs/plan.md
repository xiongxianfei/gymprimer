...
- [Exercise Image Standard](plans/2026-07-03-exercise-image-standard.md)
  ...
  - Active context: CR-EIS-M3A-2 is addressed pending re-review; M3A code-review re-review is next. CR-EIS-M3-2 owner reader-prompt evidence, replacement prompt records, and post-replacement clarity confirmation are recorded; M3 can return to code-review after M3A re-review closes.

- [Forward Head Posture Pattern Architecture](plans/2026-06-30-forward-head-posture-pattern-architecture.md)
  - Status: active
  - Plan lifecycle state: active
  - Current stage: pr
  - Active context: final verify passed with branch-ready local evidence; PR handoff is next.
...
- [Content Schema Foundation](plans/2026-06-26-content-schema-foundation.md)
  - Status: superseded
  - Superseded by: [Markdown-First Gym Primer](plans/2026-06-27-markdown-first-gym-primer.md)
