...
- [Exercise Image Standard](plans/2026-07-03-exercise-image-standard.md)
  ...
  - Active context: code-review M3A R1 requested changes for CR-EIS-M3A-1; M3A review-resolution is next. M3 still remains blocked on non-identifying reader-prompt beginner-comprehension evidence.
