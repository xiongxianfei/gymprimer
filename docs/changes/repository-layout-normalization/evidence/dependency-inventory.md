...
```bash
rg -n "the former getting-started directory|the former machine directory|the former bodyweight directory|the former nested red-flags path|media/equipment|media/movements|media/supplemental|content/|schemas/|generated/" .
```
...
| --- | --- | --- | --- |
| `the former getting-started directory/beginner-training-principles.md` | Markdown content | Move to `principles/beginner-training-principles.md`; remove `the former getting-started directory/` when empty | M3 |
| `the former machine directory/lat-pulldown.md` | Markdown content | Move to `exercises/lat-pulldown.md`; remove old path directly | M3 |
| `the former machine directory/seated-row.md` | Markdown content | Move to `exercises/seated-row.md`; remove old path directly | M3 |
| `the former machine directory/chest-press.md` | Markdown content | Move to `exercises/chest-press.md`; remove old path directly | M3 |
| `the former bodyweight directory/incline-push-up.md` | Markdown content | Move to `exercises/incline-push-up.md`; remove old path directly | M3 |
| `the former nested red-flags path.md` | Project safety reference | Move to root `RED-FLAGS.md`; remove `about/` if empty | M3 |
...
| --- | --- | --- |
| `the former nested red-flags path.md` | `README.md`, `conditions/non-specific-chronic-low-back-pain.md`, `patterns/anterior-pelvic-tilt.md`, Responsible Breadth tests/proof records | Update promoted content and README to `RED-FLAGS.md`; update or retire tests/proof records that still require old path |
| `the former getting-started directory/beginner-training-principles.md` | `README.md`, `patterns/anterior-pelvic-tilt.md`, Markdown-first specs/plans/proof records | Update promoted content to `principles/beginner-training-principles.md`; preserve old references only in historical artifacts |
| `the former machine directory/*.md` | `README.md`, `media/PROVENANCE.md`, Markdown-first specs/plans/proof records | Update promoted navigation and provenance page refs to `exercises/*.md`; preserve old references only in historical artifacts |
| `the former bodyweight directory/incline-push-up.md` | `README.md`, `media/PROVENANCE.md`, Markdown-first specs/plans/proof records | Update promoted navigation and provenance page refs to `exercises/incline-push-up.md`; preserve old references only in historical artifacts |
...
| `media/equipment/seated-row-machine-example.png` | `the former machine directory/seated-row.md`, `media/PROVENANCE.md` | Move under `media/exercises/seated-row/`; update Markdown image links and provenance row |
| `media/equipment/chest-press-machine-example.png` | `the former machine directory/chest-press.md`, `media/PROVENANCE.md` | Move under `media/exercises/chest-press/`; update Markdown image links and provenance row |
| `media/movements/front-lat-pulldown-example.png` | `the former machine directory/lat-pulldown.md`, `media/PROVENANCE.md` | Move under `media/exercises/lat-pulldown/`; update Markdown image links and provenance row |
| `media/movements/incline-push-up-phases-example.png` | `CONTRIBUTING.md`, `the former bodyweight directory/incline-push-up.md`, `media/PROVENANCE.md` | Move under `media/exercises/incline-push-up/`; update Markdown image links and provenance row |
...
- Promoted pages linking to `the former nested red-flags path.md`.
