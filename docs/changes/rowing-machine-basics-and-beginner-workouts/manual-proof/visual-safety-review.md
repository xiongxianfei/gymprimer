# Visual Safety Review: Rowing Machine Basics and Beginner Workout Guidance
...
| Image path | Referencing page | Declared purpose | Teaches one concept | Matches nearby Markdown | No in-image text | No labels or correctness marks | No identifying person | No misleading brand mark | Avoids clinical framing | Avoids unsupported claims | Color is not the only communication method | Result | Residual risk |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Re-run after any media asset, alt text, nearby Markdown, provenance row, prompt
record, or image purpose changes.
