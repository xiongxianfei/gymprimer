# RB-MP6: Expanded-Slice Comprehension Proof

- Owner role: reader-test facilitator
- Owning milestone: M3
- Automation rationale: Automated checks cannot prove beginner comprehension of purpose, boundaries, red flags, and sources.
...
- Exact steps:
  - Read each page after a short break.
