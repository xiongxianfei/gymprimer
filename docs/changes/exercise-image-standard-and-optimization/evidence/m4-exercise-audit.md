...
| `exercises/safer-running-basics.md` | 0 | none | text-only page | Safer Running Basics M2 adds the page text-only; first image batch remains deferred to the governed six-image loop. |
