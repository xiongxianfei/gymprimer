...
| `exercises/rowing-machine-advanced.md` | 0 | none | text-only page | Advanced Rowing Machine Tutorial M2 adds the companion Markdown page without media; governed images remain deferred to the later media milestone. |
...
| `exercises/safer-running-basics.md` | 6 | `exercise_movement_illustration`, `exercise_muscle_attention_illustration` | follow-up images added | Safer Running Basics M3 adds the governed six-image first batch with exact prompt records, approved provenance rows, and visual-safety review. |
...
- `docs/changes/2026-07-06-necessary-images-and-baduanjin-exercise/source-audit.md`
