...
| `exercises/rowing-machine.md` | 2 | `exercise_setup_illustration`, `exercise_movement_illustration` | follow-up images added | Follow-up rowing media enhancement added setup and movement images with provenance, prompt records, and visual-safety review. |
