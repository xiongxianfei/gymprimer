...
- Steps: Run `check_privacy.py` over the paths named in EIS-CMD4 and inspect visual-safety evidence for private health details or identifiable private people.
- Expected result: No secrets, private data, private machine paths, private health information, or identifiable private-person imagery are present.
