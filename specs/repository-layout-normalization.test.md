...
| RLN-CMD4 | `rg -n "01-getting-started|02-machines|03-bodyweight|about/red-flags" README.md SOURCES.md RED-FLAGS.md patterns conditions principles programs exercises tests tools docs/changes/repository-layout-normalization` | planned-for-milestone | migration maintainer | M3 | M3 | yes | M3 fails if active old content or red-flags references remain outside approved historical proof. | M3 validation transcript |
| RLN-CMD5 | `rg -n "media/equipment|media/movements|media/supplemental|content/|schemas/|generated/" README.md SOURCES.md RED-FLAGS.md patterns conditions principles programs exercises tests tools docs/changes/repository-layout-normalization media/PROVENANCE.md` | planned-for-milestone | migration maintainer | M4 | M4 | yes | M4 fails if active old media-bucket or historical structured-platform references remain without disposition. | M4 validation transcript |
