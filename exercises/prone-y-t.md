...
Also known as: prone Y raise, prone T raise
...
Alternate Y and T positions with the same slow control. Add load only after the unweighted version stays smooth. [ACSM][acsm-resistance-training]

## Safety notes

Stop for sharp, worsening, unusual, or unsafe symptoms. This page cannot tell whether shoulder or neck symptoms are safe for you; use the red-flags reference and professional care when needed. [NHS][nhs-neck-pain]
