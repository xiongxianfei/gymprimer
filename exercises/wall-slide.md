...
Also known as: wall angel, shoulder wall slide
...
Pause briefly at the highest controlled point.
...
Move only through the lower half of the slide or use one arm at a time.

## Harder version

Pause at the top for a slow breath, then return with the same control. Keep quality before adding repetitions. [ACSM][acsm-resistance-training]

## Safety notes

Stop the set for sharp, worsening, unusual, or unsafe symptoms. If shoulder or neck symptoms need individual judgment, use the red-flags reference and a qualified professional rather than a static exercise page. [NHS][nhs-neck-pain]
